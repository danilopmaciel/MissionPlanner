...
namespace System
{
    public static class CustomMessageBox
    {
        public delegate DialogResult ShowDelegate(string text, string caption = "",
            MessageBoxButtons buttons = MessageBoxButtons.OK, MessageBoxIcon icon = MessageBoxIcon.None, string YesText = "Sim", string NoText = "Não");//traduzido
        ...
        public static DialogResult Show(string text, string caption = "", MessageBoxButtons MessageBoxButtons = MessageBoxButtons.OK, MessageBoxIcon MessageBoxIcon = MessageBoxIcon.None, string YesText = "Sim", string NoText = "Não")//traduzido
        {
